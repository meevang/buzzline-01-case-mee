...
ADJECTIVES: list = ["spicy", "powerful", "sarcastic", "determined", "rushed"]
ACTIONS: list = ["cook", "lift weights", "text my mom", "study", "drive"]
TOPICS: list = ["Thai food", "free weight", "things to do", "streaming data", "bad roads"]
